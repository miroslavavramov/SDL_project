...
void TextureManager::Draw(string id, int x, int y, int with, int height, SDL_Renderer* pRenderer, SDL_RendererFlip flip)
{
   SDL_Rect srcRect;
   SDL_Rect destRect;
...
void TextureManager::DrawFrame(string id, int x, int y, int width, int height,int currentRow, int currentFrame, SDL_Renderer* pRenderer, SDL_RendererFlip flip)
{
   ...
   SDL_RenderCopyEx(pRenderer, m_textureMap[id], &srcRect, &destRect, 0, 0, SDL_FLIP_HORIZONTAL);
}
